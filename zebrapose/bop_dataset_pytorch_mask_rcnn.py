...
class bop_dataset_single_obj_pytorch(Dataset):
    def __init__(self, dataset_dir, data_folder, rgb_files, mask_files, mask_visib_files, gts, gt_infos, cam_params, 
                        ...
                        use_peper_salt=False, use_motion_blur=False, Detect_Bbox=None, Detect_Segmentation = None):
        ...
        self.Detect_Segmentation = Detect_Segmentation
    ...
    def __getitem__(self, index):
        ...
        if self.is_train:           
            ...
            if self.Detect_Bbox is not None:
                ...
                if self.Detect_Segmentation is not None:
                    # replace the mask with provided segmentation
                    segmentation = self.Detect_Segmentation[index]
